...
import { DIFFICULTYLEVEL_TITLE_FIELD } from "./DifficultyLevelTitle";
import { GENRE_TITLE_FIELD } from "../genre/GenreTitle";
import { LANGUAGE_TITLE_FIELD } from "../language/LanguageTitle";

export const DifficultyLevelShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
